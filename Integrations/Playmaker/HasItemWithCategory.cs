...
namespace Opsive.UltimateInventorySystem.Integrations.Playmaker
{
    ...
    public class HasItemWithCategory : FsmStateAction
    {
        ...
        public ItemCategory m_ItemCategory;
        [UIHint(UIHint.Variable)]
        [HutongGames.PlayMaker.Tooltip("The item to check within the inventory.")]
        public FsmObject m_ItemCategoryVariable;
        ...
        public void DoComparison()
        {
            ...
            var itemCategory = m_ItemCategoryVariable.Value as ItemCategory;
            if (itemCategory == null) {
                itemCategory = m_ItemCategory;
            }
            if (itemCollection != null) {
                hasItem = itemCollection.HasItem((itemCategory, m_Amount.Value), m_CheckInherently, m_CountStacks);
            } else {
                hasItem = m_Inventory.HasItem((m_Amount.Value, itemCategory), m_CheckInherently, m_CountStacks);
            }
            if (hasItem) {
