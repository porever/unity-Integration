...
namespace BehaviorDesigner.Runtime.Tasks.UltimateInventorySystem
{
    ...
    public class HasItemWithCategory : Conditional
    {
        ...
        public SharedItemCategory m_ItemCategory;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (itemCollection != null) {
                return itemCollection.HasItem((m_ItemCategory.Value, m_Amount.Value), m_CheckInherently, m_CountStacks) ?
                    TaskStatus.Success : TaskStatus.Failure;
                
            }

            return m_Inventory.HasItem((m_Amount.Value,m_ItemCategory.Value), m_CheckInherently, m_CountStacks) ?
                TaskStatus.Success : TaskStatus.Failure;
        }
